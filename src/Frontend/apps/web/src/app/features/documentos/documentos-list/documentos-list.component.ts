...
@Component({
  ...
  styles: [`
    ...
    .alert-banner {
      ...
      background: oklch(0.60 0.14 225 / 0.1); color: var(--accent);
    ...
    .badge-Valido  { background: oklch(0.60 0.14 225 / 0.12); color: var(--accent); }
    ...
    .badge-origem-ApiIngest { background: oklch(0.60 0.14 225 / 0.12); color: var(--accent); }
    .badge-origem-FocusNfe { background: oklch(0.60 0.14 225 / 0.12); color: var(--accent); }
