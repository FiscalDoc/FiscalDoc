...
<div class="page">
  ...
  styles: [`
    ...
    .kpi-icon.accent { background: oklch(0.60 0.14 225 / 0.12); color: var(--accent); }
    ...
    .avatar-sm {
      width: 28px; height: 28px; border-radius: 7px; background: oklch(0.60 0.14 225 / 0.12);
    ...
    .btn-success {
      background: oklch(0.60 0.14 225 / 0.12); color: var(--accent); border: 1px solid oklch(0.60 0.14 225 / 0.25);
      border-radius: 7px; padding: 7px 16px; font-size: 13px; font-weight: 600; cursor: pointer;
    }
    .btn-success:hover { background: oklch(0.60 0.14 225 / 0.2); }
    .btn-warning {
    ...
    .inline-success {
      ...
      background: oklch(0.60 0.14 225 / 0.08); border: 1px solid oklch(0.60 0.14 225 / 0.2);
      border-radius: 7px; padding: 8px 12px; margin-top: 4px;
    }
