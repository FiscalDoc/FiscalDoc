...
@if (showModal()) {
  ...
  styles: [`
    ...
    .success-icon { width: 60px; height: 60px; border-radius: 50%; background: oklch(0.60 0.14 225 / .12); color: var(--accent); display: flex; align-items: center; justify-content: center; }
