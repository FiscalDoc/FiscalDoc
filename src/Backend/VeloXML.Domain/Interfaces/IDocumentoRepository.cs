...
{
    Task<PagedResult<Documento>> SearchAsync(string? termo, Guid? clienteId, TipoDocumentoEnum? tipo, StatusDocumentoEnum? status, DateTime? de, DateTime? ate, int page, int pageSize, CancellationToken ct = default);
