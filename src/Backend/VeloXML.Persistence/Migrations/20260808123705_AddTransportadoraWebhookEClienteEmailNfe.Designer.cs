...
namespace VeloXML.Persistence.Migrations
{
    ...
    [Migration("20260808123705_AddTransportadoraWebhookEClienteEmailNfe")]
    partial class AddTransportadoraWebhookEClienteEmailNfe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.BlogCategoria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasDatabaseName("ix_blog_categorias_slug")
                        .HasFilter("deleted_at IS NULL");

                    b.ToTable("blog_categorias", (string)null);
                });

            modelBuilder.Entity("VeloXML.Domain.Entities.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ImagemCapaKey")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasColumnName("imagem_capa_key");

                    b.Property<string>("MetaDescricao")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasColumnName("meta_descricao");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.Cliente", b =>
                {
                    ...
                    b.Property<string>("EmailNfeDestinatarioGatilho")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("NotaFiscal")
                        .HasColumnName("email_nfe_destinatario_gatilho");

                    b.Property<bool>("EmailNfeDestinatarioHabilitado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("email_nfe_destinatario_habilitado");
                    ...
                    b.Property<string>("FocusNfeAmbiente")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("homologacao")
                        .HasColumnName("focus_nfe_ambiente");

                    b.Property<string>("FocusNfeEmpresaId")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("focus_nfe_empresa_id");

                    b.Property<string>("FocusNfeErro")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("focus_nfe_erro");

                    b.Property<string>("FocusNfeStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasDefaultValue("NaoConfigurado")
                        .HasColumnName("focus_nfe_status");

                    b.Property<string>("FocusNfeTokenHomologacao")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("focus_nfe_token_homologacao");

                    b.Property<string>("FocusNfeTokenProducao")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("focus_nfe_token_producao");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.Cobranca", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.Documento", b =>
                {
                    ...
                    b.Property<string>("DanfeJson")
                        .HasColumnType("text")
                        .HasColumnName("danfe_json");
                    ...
                    b.Property<string>("OrigemImportacao")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.Property<decimal?>("ValorAproxTributos")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("valor_aprox_tributos");

                    b.Property<decimal?>("ValorBaseCalculoIcms")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("valor_base_calculo_icms");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.ImportacaoXmlLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<List<Guid>>("DocumentoIds")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid[]")
                        .HasColumnName("documento_ids")
                        .HasDefaultValueSql("'{}'");

                    b.Property<int>("EmailsEncontrados")
                        .HasColumnType("integer")
                        .HasColumnName("emails_encontrados");
                    ...
                    b.Property<string>("Origem")
                        ...
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("ImportacaoEmail")
                    ...
                    b.Property<int>("XmlsImportados")
                        .HasColumnType("integer")
                        .HasColumnName("xmls_importados");
                    ...
                    b.HasIndex("TenantId", "ExecutadoEm");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.NfeEmissao", b =>
                {
                    ...
                    b.Property<string>("SolicitadoPorNome")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("solicitado_por_nome");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.Pedido", b =>
                {
                    ...
                    b.Property<int>("PresencaComprador")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(9)
                        .HasColumnName("presenca_comprador");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.PedidoHistorico", b =>
                {
                    ...
                    b.ToTable("pedidos_historico", (string)null);
                });
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.PedidoItem", b =>
                {
                    ...
                    b.Property<string>("IbsCbsClassificacaoTributaria")
                        .HasMaxLength(6)
                        .HasColumnType("character varying(6)")
                        .HasColumnName("ibs_cbs_classificacao_tributaria");
                    ...
                    b.Property<int>("IcmsOrigem")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("icms_origem");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.Produto", b =>
                {
                    ...
                    b.Property<decimal>("PercentualImposto")
                        ...
                        .HasColumnType("numeric(5,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("percentual_imposto");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.Transportadora", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("WebhookAtivo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("webhook_ativo");
                    ...
                    b.HasIndex("ClienteId")
                        .HasDatabaseName("ix_transportadoras_cliente_id");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_transportadoras_tenant_id");
            ...
            modelBuilder.Entity("VeloXML.Domain.Entities.BlogPost", b =>
                {
                    b.HasOne("VeloXML.Domain.Entities.BlogCategoria", "Categoria")
                        .WithMany("Posts")
