...
{
    /// <inheritdoc />
    public partial class AddNfeFeature : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Campos fiscais no Cliente
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    preco_unitario = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    cfop = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    aliquota_icms = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
                    aliquota_pis = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
                    aliquota_cofins = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
        ...
        {
            migrationBuilder.DropTable(name: "pedido_itens");
            migrationBuilder.DropTable(name: "pedidos");
            migrationBuilder.DropTable(name: "destinatarios");
            migrationBuilder.DropTable(name: "produtos");

            migrationBuilder.DropColumn(name: "regime_tributario", table: "clientes");
            migrationBuilder.DropColumn(name: "inscricao_estadual", table: "clientes");
            migrationBuilder.DropColumn(name: "inscricao_municipal", table: "clientes");
            migrationBuilder.DropColumn(name: "cnae_principal", table: "clientes");
            migrationBuilder.DropColumn(name: "serie_nfe", table: "clientes");
            migrationBuilder.DropColumn(name: "nfe_habilitado", table: "clientes");
            migrationBuilder.DropColumn(name: "certificado_a1_key", table: "clientes");
            migrationBuilder.DropColumn(name: "certificado_a1_senha", table: "clientes");
            migrationBuilder.DropColumn(name: "certificado_a1_validade", table: "clientes");
        }
    }
}
